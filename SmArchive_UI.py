...
class Ui_SmArchiveMainWindow(object):
    def setupUi(self, SmArchiveMainWindow):
        SmArchiveMainWindow.setObjectName("SmArchiveMainWindow")
        SmArchiveMainWindow.resize(649, 419)
        SmArchiveMainWindow.setMaximumSize(QtCore.QSize(650, 450))
        self.centralwidget = QtWidgets.QWidget(SmArchiveMainWindow)
        ...
        self.txtFileExtension.setObjectName("txtFileExtension")
        ...
        SmArchiveMainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(SmArchiveMainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 649, 21))
        self.menubar.setObjectName("menubar")
        SmArchiveMainWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(SmArchiveMainWindow)
        self.statusbar.setObjectName("statusbar")
        SmArchiveMainWindow.setStatusBar(self.statusbar)

        self.retranslateUi(SmArchiveMainWindow)
        self.sldFileNameSuffixLength.valueChanged['int'].connect(self.lblFileNameSuffixLengthValue.setNum) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(SmArchiveMainWindow)
    ...
    def retranslateUi(self, SmArchiveMainWindow):
        ...
        self.txtSourceDirectory.setText(_translate("SmArchiveMainWindow", "C:\\"))
        self.txtArchiveDirectory.setText(_translate("SmArchiveMainWindow", "C:\\"))
        ...
        self.lblArchiveDirectory.setText(_translate("SmArchiveMainWindow", "Archive Directory:"))
        self.lblFileNameSuffixLengthValue.setText(_translate("SmArchiveMainWindow", "1"))
        self.lblFileNameSuffixLength.setText(_translate("SmArchiveMainWindow", "FileName Suffix Length:"))
        self.chkOverwriteMode.setText(_translate("SmArchiveMainWindow", "Overwrite Mode (Automatically overwrites duplicate files)"))
        self.chkTestMode.setText(_translate("SmArchiveMainWindow", "Test Mode (Won\'t move files, just tells you what it would have done)"))
        self.chkSkipMode.setText(_translate("SmArchiveMainWindow", "Skip Mode (Skips duplicate files)"))
        self.lblFileExtension.setText(_translate("SmArchiveMainWindow", "File Extension:"))
        self.txtFileExtension.setText(_translate("SmArchiveMainWindow", "*.*"))
        self.lblOutput.setText(_translate("SmArchiveMainWindow", "Output:"))
        self.btnExecute.setText(_translate("SmArchiveMainWindow", "Archive!"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    SmArchiveMainWindow = QtWidgets.QMainWindow()
    ui = Ui_SmArchiveMainWindow()
    ui.setupUi(SmArchiveMainWindow)
    SmArchiveMainWindow.show()
    sys.exit(app.exec())
